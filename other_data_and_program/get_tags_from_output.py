...
# with open('Nov_24_output3.txt') as f:
#     contents = f.read()
#     regex = "\"tag_name\": \"+(.*?)\","
...
#     s = set(tags)
#
# with open('tag_names.txt', 'a') as f:
#     for tag in s:
#         try:
#             f.write(tag.encode('utf-8').decode("unicode_escape"))
#             f.write("\n")
#         except:
#             pass

keywords = ['MAD', 'AMV', 'MMD', '3D', '短片', '手书', '配音', '手办', '模玩', '特摄', '动漫杂谈',
